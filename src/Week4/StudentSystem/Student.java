...
public class Student {
    ...
    public void addBulkExamNote(int mat, int fizik, int kimya,int matsoz, int kimsoz, int fizsoz) {
        ...
        if (matsoz >= 0 && matsoz <= 100) {
            this.mat.oralnote = matsoz;
        }

        if (fizsoz >= 0 && fizsoz <= 100) {
            this.fizik.oralnote = fizsoz;
        }

        if (kimsoz >= 0 && kimsoz <= 100) {
            this.kimya.oralnote = kimsoz;
        }
